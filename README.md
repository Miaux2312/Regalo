...
├── images/          <- Carpeta donde pondrás tus 6 fotos
│   ├── foto1.jpg
│   ├── foto2.jpg
│   ├── foto3.jpg
│   ├── foto4.jpg
...
└── music/           <- Carpeta donde pondrás tus canciones en formato MP3
    ...
    ├── cancion2.mp3 (Escena Morfina)
    └── cancion3.mp3 (Escena Carta)
    (O simplemente 'cancion.mp3' para todo el sitio)
```

---

## 📸 1. ¿Cómo cargar tus 6 fotos?

1. Elige 6 fotos que quieras dedicarle a Samantha.
...
4. ¡Listo! La página las cargará automáticamente en la cuadrícula de 6 marcos polaroid con detalles florales. Si Samantha toca una foto en su celular, se abrirá en pantalla completa.
...
* **Opción B (Una canción diferente para cada escena):**
  ...
  - `music/cancion2.mp3` (Sonará en la Escena Morfina de Humbe)
...
1. Asegúrate de hacer commit y push de todos los archivos a tu repositorio de GitHub:
   ```bash
   git add .
   git commit -m "Regalo para Samantha con 6 fotos y estilo Morfina"
   git push origin main
   ```
2. En GitHub, entra a tu repositorio y ve a **Settings** (Configuración) -> **Pages**.
3. En **Build and deployment**:
   - Source: Selecciona **Deploy from a branch**.
   - Branch: Elige `main` (o `master`) y la carpeta `/ (root)`.
   - Haz clic en **Save**.
4. En 1 o 2 minutos, GitHub te dará el enlace público.
